...
/** Projectile combat figures shown by Pioneer Station for weapons and special ammunition. */
export interface ProjectileStats { innerDamage: number; outerDamage: number; blastRadius: number; }
