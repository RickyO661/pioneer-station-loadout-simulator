...
interface Props { title: string; category: ItemCategory; items: Item[]; entries: Array<LoadoutEntry & { item: Item; stackKg: number; stackPrice: number; eligibility: { eligible: boolean; messages: string[] } }>; gameClass: GameClass; classes: GameClass[]; onAdd: (id: number) => void; onQuantity: (entryId: string, quantity: number) => void; onRemove: (entryId: string) => void; }
